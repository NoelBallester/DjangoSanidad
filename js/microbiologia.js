...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  const guardarInformeMedico = async () => {
    ...
    const datosReporte = {
      informe_descripcion: microbiologiaInformeDescripcion.value,
      informe_fecha: microbiologiaInformeFecha.value,
      informe_tincion: microbiologiaInformeTincion.value,
      informe_observaciones: microbiologiaInformeObservaciones.value,
    };
  ...
  const guardarInformeAlBackend = async (datosReporte) => {
    ...
    console.log("URL:", `/api/microbiologias/${currentMicrobiologiaId}/actualizar_informe/`);
    ...
    try {
      const res = await fetch(`/api/microbiologias/${currentMicrobiologiaId}/actualizar_informe/`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          "X-CSRFToken": getCookie("csrftoken"),
      ...
      if (res.ok) {
        ...
        microbiologiaInformeFecha.value = "";
        microbiologiaInformeTincion.value = "";
        microbiologiaInformeObservaciones.value = "";
        microbiologiaInformeImagen.value = "";
      } else {
