...
const imprimirDataCassette = (respuesta) => {
  ...
  new QRious({
    ...
    value: buildResolverUrl(respuesta.qr_casette), // La URL o el texto
    size: QR_RENDER_SIZE,
    background: "#ffffff",
    backgroundAlpha: 1,
    foreground: "#000000",
...
if (btnToggleInforme) {
  ...
  btnToggleInforme.title = "Selecciona un cassette para crear o ver informe";
}

if (btnToggleInforme && sectionMuestras && sectionInforme) {
  btnToggleInforme.addEventListener("click", () => {
    if (!currentCassetteId) {
      mostrarAvisoToast("Selecciona un cassette antes de abrir Informe.", "warning");
      return;
    }
