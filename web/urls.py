...
urlpatterns = [
    ...
    path('qr/resolver/', views.qr_resolver, name='qr_resolver'),
    ...
    path('cassettes/<int:pk>/informes/<int:informe_pk>/eliminar/', views.cassette_informe_delete, name='cassette_informe_delete'),
    ...
    path('citologias/<int:pk>/informes/<int:informe_pk>/eliminar/', views.citologia_informe_delete,  name='citologia_informe_delete'),
